...
// run. The real agent plugin lives in qwbe-packs/plugins/activegraph and carries its own probe
// pair; this one covers what
...
// Every mounted plugin goes aside, not just example-plugin: after an install-from
