...
// Declared in store-contract.ts (leaf, QWB-70); re-exported below so importers of the kernel
// manifest surface keep working.
import type { ActivityRow, ActivityTools, CommentRow, CubeStore } from "./store-contract.ts"

export type { ActivityRow, ActivityTools, CommentRow, CubeStore }
